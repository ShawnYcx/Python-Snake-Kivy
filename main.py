import kivy
kivy.require('1.9.0')  # update with your current version
 
# import the kivy libraries used by our classes
...
class Playground(Widget):
    ...
    def new_snake(self):
        ...
        start_coord = (randint(2, self.col_number - 2), randint(2, self.row_number - 2))
        
        self.snake.set_position(start_coord)

        rand_index = randint(0, 3)
        start_direction = ["Right", "Left", "Up", "Down"][rand_index]

        self.snake.set_direction(start_direction)

    def pop_fruit(self, *args):
        random_coord = [randint(1, self.col_number), randint(1, self.row_number)]
    ...
    def handle_outbound(self):
        ...
        #Handle out of bound snake so that it appears on the opposite side.
...
class SnakeTail(Widget):
    ...
    # Blocks position on grid
    blocks_positions = ListProperty()

    # Blocks drawn on canvas
